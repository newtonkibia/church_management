...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Prayer Requests</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-requester_phone">
                                        <th class="title"> Requester Phone: </th>
                                        <td class="value">
                                            <span  data-value="<?php echo $data['requester_phone']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("prayer_requests/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="requester_phone" 
                                                data-title="Enter Requester Phone" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" >
                                                <?php echo $data['requester_phone']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-requester_email">
                                        <th class="title"> Requester Email: </th>
                                        <td class="value">
                                            <span  data-value="<?php echo $data['requester_email']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("prayer_requests/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="requester_email" 
                                                data-title="Enter Requester Email" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="email" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" >
                                                <?php echo $data['requester_email']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-prayer_request">
                                        <th class="title"> Prayer Request: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-is_anonymous">
                                        <th class="title"> Is Anonymous: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-responded_by">
                                        <th class="title"> Responded By: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-responded_at">
                                        <th class="title"> Responded At: </th>
                                        <td class="value">
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("prayer_requests/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("prayer_requests/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
