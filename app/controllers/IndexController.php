...
class IndexController extends BaseController{
	...
	private function login_user($username , $password_text, $rememberme = false){
		...
		$db->where("membership_no", $username)->orWhere("email", $username);
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("membership_no","first_name","last_name","phone","email","gender","date_of_birth","marital_status","family_id","residence_location","residence_city","residence_area","baptism_date","membership_date","role","profile_photo","username","password"); //registration fields
